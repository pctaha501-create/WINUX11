...
Item {
    ...
    Row {
        ...
        Text {
            ...
            text: Qt.formatTime(new Date(),"HH:mm"); color: "#FFFFFF"; font.pixelSize: 13; font.weight: Font.Medium
    ...
    GlassPanel {
        ...
        glassColor:"#F00A0E15"; borderColor:"#50FFFFFF"; radius:28
