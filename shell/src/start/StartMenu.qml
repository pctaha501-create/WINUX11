...
Item {
    ...
    GlassPanel {
        ...
        Text { x: 28; y: 164; text: "Pinned"; color: "#FFFFFF"; font.pixelSize: 13 }

        Grid {
            x: 26; y: 198; columns: 4; columnSpacing: 10; rowSpacing: 10
            Repeater {
                model: [
                    {name:"File Explorer",icon:"explorer.svg",cmd:"explorer"},{name:"Browser",icon:"browser.svg",cmd:"browser"},
                    {name:"Terminal",icon:"terminal.svg",cmd:"terminal"},{name:"Network",icon:"network.svg",cmd:"network"},
                    {name:"Settings",icon:"settings.svg",cmd:"settings"},{name:"Security",icon:"focus.svg",cmd:"security"},
                    {name:"Notifications",icon:"notifications.svg",cmd:"notifications"},{name:"Audio",icon:"volume.svg",cmd:"audio"}
                ]
                delegate: Rectangle {
                    ...
                    Image { x: 17; y: 17; width: 28; height: 28; source: "qrc:/qt/qml/WINUX11/assets/icons/" + modelData.icon; sourceSize: Qt.size(56,56) }
                    Text { x: 17; y: 62; text: modelData.name; color: "#FFFFFF"; font.pixelSize: 13 }
