...
Item {
    ...
    signal panelToggled()
    property bool networkEnabled: systemService ? systemService.networkEnabled : true
    property bool bluetoothEnabled: systemService ? systemService.bluetoothEnabled : false
    property bool nightLightEnabled: false
    property bool focusEnabled: false
    property int displayVolume: systemService ? systemService.volume : 40
